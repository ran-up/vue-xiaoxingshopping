  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        <p @click="changAddressType(addressList, index)">
      ...
      <div class="detail">
        ...
        <ul
          ...
          :key="detail.skuId"
        >
          <li><img :src="detail.imgUrl" alt="" style="width: 100px" /></li>
          <li>
            <p>{{ detail.skuName }}</p>
            <h4>7天无理由退货</h4>
          </li>
    ...
    <div class="trade">
      <div class="price">
        应付金额:　<span>¥{{ shopInfo.totalAmount }}.00</span>
      </div>
...
export default {
  ...
  methods: {
    ...
    // 改变用户地址选中状态
    changAddressType(addressList, index) {

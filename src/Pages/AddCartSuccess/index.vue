      ...
      <div class="goods">
        <div class="left-good">
          ...
          <div class="right-info">
            ...
            <p class="attr">
              {{ skuSaleAttrValue }} 数量：{{ $route.query.skuNum }}
            </p>
          </div>
        </div>
  ...
  computed: {
    ...
    skuSaleAttrValue() {
      ...
      this.skuInfo.skuSaleAttrValueList.forEach((item) => {
        all.push(`${item.saleAttrName}:${item.saleAttrValueName}`);
      });
      // console.log(all);
      // console.log(all.toString().replace(/,/g, " "));
      return all.toString().replace(/,/g, " ");
    },
  },
};
</script>

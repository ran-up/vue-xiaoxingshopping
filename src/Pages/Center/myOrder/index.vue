<template>
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders" v-for="record in records" :key="record.id">
        <table class="order-item">
          ...
          <tbody>
            ...
            >
              ...
              <td :rowspan="orderDetail.length" width="8%" class="center">
                {{ record.consignee }}
              </td>
              <td :rowspan="orderDetail.length" width="13%" class="center">
                <ul class="unstyled">
                  <li>总金额¥{{ orderDetail.orderPrice }}.00</li>
                  <li
                    v-text="
                      orderDetail.paymentWay == 'ONLINE'
                        ? '在线支付'
                        : '货到付款'
                    "
                  ></li>
